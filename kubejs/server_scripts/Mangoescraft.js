...
//raw uranium, limesand, raw copper, raw zinc, raw gold, flint, ancient debris shard, gold nugget, copper nugget, iron nugget, zinc nugget, electrum nugget, osmium nugget
    ...
    event.recipes.create.crushing([Item.of('mekanism:nugget_osmium').withChance(0.20), Item.of('mekanism:nugget_uranium').withChance(0.20), Item.of('mekanism:nugget_tin').withChance(0.20), Item.of('mekanism:nugget_lead').withChance(0.20)], 'minecraft:dripstone_block')
